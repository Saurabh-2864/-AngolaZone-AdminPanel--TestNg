...
@Test (priority=14,groups="Users")
	
	public void ClickOnBlockedUSer() throws Exception{
   ...
   driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[2]/div/div[1]/div/a[1]")).click();//Click on Active User
